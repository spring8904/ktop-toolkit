...
const lamTron = (num) => Math.round(num * 100) / 100
...
formCream.addEventListener('submit', (event) => {
  ...
  result.value = lamTron((data - 300) / 1500)
})
...
formCream2.addEventListener('submit', (event) => {
  ...
  result.value = lamTron((data - 200) / 1500)
})
...
formCream3.addEventListener('submit', (event) => {
  ...
  result.value = lamTron((data - 500) / 1500)
})
...
formCoke.addEventListener('submit', (event) => {
  ...
  result2.value = lamTron((data - 1) * 0.8)
})
...
formSprite.addEventListener('submit', (event) => {
  ...
  result2.value = lamTron((data - 0.8) * 0.8)
})
